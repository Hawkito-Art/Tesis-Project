...
export function CalcResultsClient() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () =>
      calculationsApi.list({ page: page + 1, entity: entityFilter || undefined, period: periodFilter || undefined }),
  })
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <ExportButton
            ...
            params={{ entity: entityFilter || undefined, period: periodFilter || undefined }}
          />
        </div>
      </div>
